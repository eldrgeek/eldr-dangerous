      ...
      <React.Fragment>
        <Hidden only="xs">
          <DialogActions className={classes.dialogActions}>
            <Button
              ...
              variant="contained"
              onClick={() =>
                onAuthProviderClick(new firebase.auth.FacebookAuthProvider())
              }
            >
            ...
            <Button
              ...
              variant="contained"
              onClick={() =>
                onAuthProviderClick(new firebase.auth.GoogleAuthProvider())
              }
            >
            ...
            <Button
              ...
              variant="contained"
              onClick={() =>
                onAuthProviderClick(new firebase.auth.GithubAuthProvider())
              }
            >
            ...
            <Button
              ...
              variant="contained"
              onClick={() =>
                onAuthProviderClick(new firebase.auth.TwitterAuthProvider())
              }
            >
        ...
        <Hidden only={["sm", "md", "lg", "xl"]}>
          <DialogActions className={classes.dialogActionsMobile} disableSpacing>
            <Button
              className={`${classes.facebook} ${classes.buttonMobile}`}
              disabled={isPerformingAuthAction}
              variant="contained"
              onClick={() =>
                onAuthProviderClick(new firebase.auth.FacebookAuthProvider())
            ...
            <Button
              className={`${classes.gitHub} ${classes.buttonMobile}`}
              disabled={isPerformingAuthAction}
              variant="contained"
              onClick={() =>
                onAuthProviderClick(new firebase.auth.GithubAuthProvider())
            ...
            <Button
              className={`${classes.twitter} ${classes.buttonMobile}`}
              disabled={isPerformingAuthAction}
              variant="contained"
              onClick={() =>
                onAuthProviderClick(new firebase.auth.TwitterAuthProvider())
